 ...
 * @author Samsu
 */
public class OtherCountriesLandscapeview extends MigPane {

   private      MigPane     topBar = new MigPane("","[grow][]","[grow]");
   private      MigPane     botBar = new MigPane(",wrap3", "[][][]", "20[]0[]0[]0[]0[]");
   private      Label       title= new Label("Weather that you are Tracking");
   private      Font        titleFont = new Font("Arial", 24);
   private      ToggleButton menu = new ToggleButton();

    public OtherCountriesLandscapeview() {
...
//        topBar.add(menu,"gapleft 120px");
        topBar.add(menu,"span");
        botBar.add(getWeatherReading2());
        botBar.add(somepane,"top");
        botBar.add(somepane2,"top");
        topBar.getStylesheets().add(OtherCountriesLandscapeview.class.getResource("OCL.css").toExternalForm());
        botBar.getStylesheets().add(OtherCountriesLandscapeview.class.getResource("OCL.css").toExternalForm());
        this.add(topBar, "width 480,height 50");
        this.add(botBar, "width 480,height 270");
        topBar.setId("tb");
        botBar.setId("bb");
