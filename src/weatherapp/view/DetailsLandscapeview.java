...
public class DetailsLandscapeview extends MigPane {
    ...
    private     ImageView               statusOFWeatherImage;
    private     ToggleButton            menu;



// ******************** Constructors **************************************
    public DetailsLandscapeview() {
            super("wrap,debug", "[]", "[]20[]");
            topBlock = getTopBlock();
            botBlock = getBotBlock();

            this.add(topBlock, "top");
...
// ******************** Initialization(topBlock) **************************************
    private MigPane getTopBlock() {
            ...
            MigPane topBlock = new MigPane("debug,insets 0 ,wrap3", "[grow][]", "[][][]");
            ...
            topBlock.add(time, "top,gapright 205px,gapleft 4px,split2,flowy");
            topBlock.add(loc, "gaptop 3px,gapleft 5px");
